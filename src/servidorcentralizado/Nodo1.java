 ...
 * @author ibrah
 */
public class Nodo1 extends javax.swing.JFrame {
    Servidor lider = new Servidor();
    /**
     * Creates new form Nodo1
     */
    public Nodo1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButtonSolicitar.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        ...
        jButtonLiberar.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
    ...
    private void jButtonLiberarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLiberarActionPerformed
        lider.FreeServidor();
        JOptionPane.showMessageDialog(this, "Nodo 1 Liberado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nodo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
